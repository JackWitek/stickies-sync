...
namespace X.HtmlToRtfConverter.Css
{
    internal class CssSize
    {
        ...
        public CssSize(string value)
        {
            ...
            System.Diagnostics.Debug.WriteLine("Processing value: " + value);
            ...
            System.Diagnostics.Debug.WriteLine("Have numeric value of: " + Value);
